angular
    .module('clientIO')
    .factory('spectrumPoint', spectrumPoint);


spectrumPoint.$inject = ['UnitListFactory'];


function spectrumPoint(UnitListFactory) {
    ...
    function inp(defs) {
        ...
        _.each(defs, function(def, attr) {
            ...
            ret[attr] = _.extend({}, spectrumDefs[attr], def);
        });
        return ret;
    }

    return {
        spectrumProps: spectrumProps
    }
}