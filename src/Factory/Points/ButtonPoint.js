angular
    .module('clientIO')
    .factory('buttonPoint', buttonPoint);


buttonPoint.$inject = ['UnitListFactory'];


function buttonPoint(UnitListFactory) {
    ...
    var buttonProps = {
        ...
        inputs: {
            attrs: {
                text: inp({
                    text: {group: 'Button Specific Properties', index: 1},
                    'font-size': {group: 'Button  Specific Properties', index: 2},
                    'font-family': {group: 'Button  Specific Properties', index: 3},
                    'stroke': {type: 'color', group: 'Button  Specific Properties', index: 4, defaultValue: '#000000'},
                    'EngineeringUnits': {group: 'Button  Specific Properties', index: 5}
    ...
    function inp(defs) {
        ...
        _.each(defs, function(def, attr) {
            ...
            ret[attr] = _.extend({}, buttonDefs[attr], def);
        });
        return ret;
    }
