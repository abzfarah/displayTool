angular
    .module('clientIO')
    .factory('livetextPoint',livetextPoint);


livetextPoint.$inject = ['UnitListFactory'];


function livetextPoint(UnitListFactory) {
    ...
    function inp(defs) {
        ...
        _.each(defs, function(def, attr) {
            ...
            ret[attr] = _.extend({}, livetextDefs[attr], def);
        });
        return ret;
    }

    return {
        livetextProps: livetextProps
    }
