angular
    .module('clientIO')
    .factory('groupboxPoint', groupboxPoint);


groupboxPoint.$inject = ['UnitListFactory'];


function groupboxPoint(UnitListFactory) {
    ...
    function inp(defs) {
        ...
        _.each(defs, function(def, attr) {
            ...
            ret[attr] = _.extend({}, groupboxDefs[attr], def);
        });
        return ret;
    }
    return {
        groupboxProps: groupboxPoint
    }
}