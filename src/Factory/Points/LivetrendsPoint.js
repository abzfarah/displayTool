angular
    .module('clientIO')
    .factory('livetrendsPoint',livetrendsPoint);


livetrendsPoint.$inject = ['UnitListFactory'];


function livetrendsPoint(UnitListFactory) {
    ...
    function inp(defs) {
        ...
        _.each(defs, function(def, attr) {
            ...
            ret[attr] = _.extend({}, livetrendsDefs[attr], def);
        });
        return ret;
    }

    return {
        livetrendsProps: livetrendsProps
    }
