angular.module('clientIO')
    ...
    InspectorDataCtrl.$inject = ['UnitListFactory', 'permissionProp', 'PointProperties'];

    function InspectorDataCtrl (UnitListFactory, permissionProp, PointProperties) {

        var i =  permissionProp.permissionProps.inputs;

        var LabelSpecificProperties = {
        ...
        var InspectorDefs = {
            ...
            'permissions': permissionProp.permissionProps

        };

        return { InspectorDefs:InspectorDefs,
                 CommonInspectorInputs:CommonInspectorInputs,
                 CommonInspectorGroups:CommonInspectorGroups
